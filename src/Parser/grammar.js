...
(function () {
  ...
  var grammar = {
    ...
    ParserRules: [
      ...
      { "name": "sql", "symbols": ["create_database"], "postprocess": d => d[0] },
      { "name": "sql", "symbols": ["create_table"], "postprocess": d => d[0] },
      { "name": "sql", "symbols": ["use_database"], "postprocess": d => d[0] },
      { "name": "sql", "symbols": ["insert_data"], "postprocess": d => d[0] },
      { "name": "sql", "symbols": ["update_data"], "postprocess": d => d[0] },
      { "name": "sql", "symbols": ["delete_data"], "postprocess": d => d[0] },
      { "name": "create_database$subexpression$1", "symbols": [/[cC]/, /[rR]/, /[eE]/, /[aA]/, /[tT]/, /[eE]/], "postprocess": function (d) { return d.join(""); } },
      ...
      { "name": "dataType$subexpression$2", "symbols": [/[iI]/, /[nN]/, /[tT]/, /[eE]/, /[gG]/, /[eE]/, /[rR]/], "postprocess": function (d) { return d.join(""); } },
      { "name": "dataType", "symbols": ["dataType$subexpression$2"] },
      { "name": "dataType$subexpression$3", "symbols": [/[vV]/, /[aA]/, /[rR]/, /[cC]/, /[hH]/, /[aA]/, /[rR]/], "postprocess": function (d) { return d.join(""); } },
      { "name": "dataType", "symbols": ["dataType$subexpression$3"] },
      { "name": "dataType$subexpression$4", "symbols": [/[dD]/, /[aA]/, /[tT]/, /[eE]/], "postprocess": function (d) { return d.join(""); } },
      { "name": "dataType", "symbols": ["dataType$subexpression$4"] },
      { "name": "dataType$subexpression$5", "symbols": [/[fF]/, /[lL]/, /[oO]/, /[aA]/, /[tT]/], "postprocess": function (d) { return d.join(""); } },
      { "name": "dataType", "symbols": ["dataType$subexpression$5"] },
      { "name": "dataType$subexpression$6", "symbols": [/[bB]/, /[oO]/, /[oO]/, /[lL]/, /[eE]/, /[aA]/, /[nN]/], "postprocess": function (d) { return d.join(""); } },
      { "name": "dataType", "symbols": ["dataType$subexpression$6"] },
      { "name": "use_database$subexpression$1", "symbols": [/[uU]/, /[sS]/, /[eE]/], "postprocess": function (d) { return d.join(""); } },
      {
        "name": "use_database", "symbols": ["use_database$subexpression$1", "_", "identifier"], "postprocess":
          d => ({ type: 'use_database', name: d[2] })
      },
      { "name": "insert_data$subexpression$1", "symbols": [/[iI]/, /[nN]/, /[sS]/, /[eE]/, /[rR]/, /[tT]/], "postprocess": function (d) { return d.join(""); } },
      { "name": "insert_data$subexpression$2", "symbols": [/[iI]/, /[nN]/, /[tT]/, /[oO]/], "postprocess": function (d) { return d.join(""); } },
      { "name": "insert_data$subexpression$3", "symbols": [/[vV]/, /[aA]/, /[lL]/, /[uU]/, /[eE]/, /[sS]/], "postprocess": function (d) { return d.join(""); } },
      {
        "name": "insert_data", "symbols": ["insert_data$subexpression$1", "_", "insert_data$subexpression$2", "_", "identifier", "_", "insert_data$subexpression$3", "_", { "literal": "(" }, "_", "valueList", "_", { "literal": ")" }], "postprocess":
          d => ({ type: 'insert_data', table: d[2], values: d[5] })
      },
      { "name": "valueList$ebnf$1", "symbols": [] },
      { "name": "valueList$ebnf$1$subexpression$1", "symbols": [{ "literal": "," }, "_", "value"] },
      ...
      { "name": "valueList", "symbols": ["value", "_", "valueList$ebnf$1"] },
      { "name": "value", "symbols": ["string"] },
      { "name": "value", "symbols": ["number"] },
      { "name": "update_data$subexpression$1", "symbols": [/[uU]/, /[pP]/, /[dD]/, /[aA]/, /[tT]/, /[eE]/], "postprocess": function (d) { return d.join(""); } },
      { "name": "update_data$subexpression$2", "symbols": [/[sS]/, /[eE]/, /[tT]/], "postprocess": function (d) { return d.join(""); } },
      { "name": "update_data$ebnf$1", "symbols": ["where_clause"], "postprocess": id },
      { "name": "update_data$ebnf$1", "symbols": [], "postprocess": function (d) { return null; } },
      {
        "name": "update_data", "symbols": ["update_data$subexpression$1", "_", "identifier", "_", "update_data$subexpression$2", "_", "setList", "_", "update_data$ebnf$1"], "postprocess": d => ({
          type: 'update',
          table: d[2],
          set: d[6],
          where: d[8]
      ...
      { "name": "setList$ebnf$1", "symbols": [] },
      { "name": "setList$ebnf$1$subexpression$1", "symbols": [{ "literal": "," }, "_", "setExpression"] },
      { "name": "setList$ebnf$1", "symbols": ["setList$ebnf$1", "setList$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) { return d[0].concat([d[1]]); } },
      { "name": "setList", "symbols": ["setExpression", "_", "setList$ebnf$1"], "postprocess": d => [d[0]].concat(d[2] ? d[2].map(dd => dd[2]) : []) },
      { "name": "setExpression", "symbols": ["identifier", "_", { "literal": "=" }, "_", "value"], "postprocess": d => ({ field: d[0], value: d[4] }) },
      { "name": "delete_data$subexpression$1", "symbols": [/[dD]/, /[eE]/, /[lL]/, /[eE]/, /[tT]/, /[eE]/], "postprocess": function (d) { return d.join(""); } },
      { "name": "delete_data$subexpression$2", "symbols": [/[fF]/, /[rR]/, /[oO]/, /[mM]/], "postprocess": function (d) { return d.join(""); } },
      { "name": "delete_data$ebnf$1", "symbols": ["where_clause"], "postprocess": id },
      { "name": "delete_data$ebnf$1", "symbols": [], "postprocess": function (d) { return null; } },
      {
        "name": "delete_data", "symbols": ["delete_data$subexpression$1", "_", "delete_data$subexpression$2", "_", "identifier", "_", "delete_data$ebnf$1"], postprocess: data => {
          return {
            operation: 'delete',
            table: data[4], // Assuming data[4] is the table name
            where: data[6]  // Assuming data[6] is the where condition
          };
        }
      },
      ...
      { "name": "table_ref", "symbols": ["table_ref", "table_ref$subexpression$1", "JOIN", "__", "table", "__", "on_expr"], "postprocess": x => tableRef(x, { on: x[6].expr }) },
      ...
      { "name": "table_ref$subexpression$3", "symbols": ["AS", "__"] },
      { "name": "table_ref$subexpression$3", "symbols": ["__"] },
      { "name": "table_ref", "symbols": ["table_ref", "table_ref$subexpression$2", "JOIN", "__", "query_spec", "table_ref$subexpression$3", "identifier", "__", "on_expr"], "postprocess": x => tableRef(x, { on: x[8].expr, alias: x[6] }) },
      ...
      { "name": "table_ref", "symbols": ["table_ref", "table_ref$subexpression$4", "JOIN", "__", "table", "__", "using_expr"], "postprocess": x => tableRef(x, { using: x[6].list }) },
      { "name": "table_ref$subexpression$5", "symbols": ["__", "LEFT", "__"] },
      { "name": "table_ref$subexpression$5", "symbols": ["__", "RIGHT", "__"] },
      { "name": "table_ref$subexpression$5", "symbols": ["__", "INNER", "__"] },
      { "name": "table_ref$subexpression$5", "symbols": ["__"] },
      { "name": "table_ref$subexpression$6", "symbols": ["AS", "__"] },
      { "name": "table_ref$subexpression$6", "symbols": ["__"] },
      { "name": "table_ref", "symbols": ["table_ref", "table_ref$subexpression$5", "JOIN", "__", "query_spec", "table_ref$subexpression$6", "identifier", "__", "using_expr"], "postprocess": x => tableRef(x, { using: x[8].list, alias: x[6] }) },
      { "name": "on_expr", "symbols": ["ON", "__", "expr"], "postprocess": x => ({ type: 'on', expr: x[2] }) },
      { "name": "on_expr", "symbols": ["ON", { "literal": "(" }, "_", "expr", "_", { "literal": ")" }], "postprocess": x => ({ type: 'on', expr: x[3] }) },
      { "name": "using_expr", "symbols": ["USING", "_", { "literal": "(" }, "_", "identifier_comma_list", "_", { "literal": ")" }], "postprocess": x => ({ type: 'using', list: x[4] }) },
      ...
      { "name": "table", "symbols": ["identifier", { "literal": "." }, "identifier", "table$subexpression$1", "identifier"], "postprocess": d => ({ type: 'table', table: d[0].value + '.' + d[2].value, alias: d[4].value }) },
